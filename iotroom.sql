...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2016 at 02:50 AM
...
--
ALTER TABLE `temp_log`
  ADD CONSTRAINT `temp_log_ibfk_1` FOREIGN KEY (`system_id`) REFERENCES `system` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`system_id`) REFERENCES `system` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
